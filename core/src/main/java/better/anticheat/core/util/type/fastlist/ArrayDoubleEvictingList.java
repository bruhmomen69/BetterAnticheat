...
/**
 * A size-limited list implementation for storing double values with eviction behavior when the maximum size is reached.
 ...
 *
 * @see DoubleStream for streaming capabilities
 */
@Getter
public class ArrayDoubleEvictingList {
    /**
     * The backing array to store double values. Size is fixed at construction.
     */
    ...
    /**
     * Constructs a new ArrayDoubleEvictingList with the specified maximum size.
    ...
    /**
     * Returns a sequential DoubleStream over the elements in this list.
    ...
    /**
     * Checks if the specified double value is contained in the list.
     * This method iterates through the array to find a matching element.
     *
     * @param dub the double value to search for
     ...
     *
     * @return an iterator over the double values
    ...
    /**
     * Adds a double value to the list. If the list is full, the oldest element is overwritten due to circular behavior.
     * The count is updated to reflect the current position, and the full flag is set if the maximum size is reached.
     *
     * @param item the double value to add
     */
    ...
    /**
     * Removes the first occurrence of the specified double value from the list.
     ...
     *
     * @param item the double value to remove
     */
